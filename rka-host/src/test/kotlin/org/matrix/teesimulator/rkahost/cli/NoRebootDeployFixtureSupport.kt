...
internal enum class FixtureMutation {
    ...
    ARCHIVE_ARTIFACT_PARENT_ALIAS,
    ARCHIVE_ARTIFACT_LEADING_SLASH,
    ARCHIVE_ARTIFACT_TRAILING_SLASH,
    ARCHIVE_ARTIFACT_DOUBLE_SLASH,
    ARCHIVE_ARTIFACT_BACKSLASH,
    ARCHIVE_ARTIFACT_CONTROL,
    ARCHIVE_ARTIFACT_WHITESPACE,
    ARCHIVE_ARTIFACT_CANONICAL_ALIAS_DUPLICATE,
