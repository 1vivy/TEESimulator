...
public interface IKeyMintDevice extends android.os.IInterface
{
    ...
    @Override public boolean onTransact(int code, android.os.Parcel data, android.os.Parcel reply, int flags) throws android.os.RemoteException
    {
      ...
      switch (code)
      {
        ...
        case TRANSACTION_generateKey:
        {
          ...
          _arg1 = _Parcel.readTypedObject(data, android.hardware.security.keymint.AttestationKey.CREATOR);
        ...
        case TRANSACTION_importKey:
        {
          ...
          _arg3 = _Parcel.readTypedObject(data, android.hardware.security.keymint.AttestationKey.CREATOR);
        ...
        case TRANSACTION_begin:
        {
          ...
          _arg3 = _Parcel.readTypedObject(data, android.hardware.security.keymint.HardwareAuthToken.CREATOR);
        ...
        case TRANSACTION_deviceLocked:
        {
          ...
          _arg1 = _Parcel.readTypedObject(data, android.hardware.security.secureclock.TimeStampToken.CREATOR);
    ...
    private static class Proxy implements android.hardware.security.keymint.IKeyMintDevice
    {
      ...
      @Override public android.hardware.security.keymint.KeyMintHardwareInfo getHardwareInfo() throws android.os.RemoteException
      {
        ...
        try {
          ...
          _result = _Parcel.readTypedObject(_reply, android.hardware.security.keymint.KeyMintHardwareInfo.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public android.hardware.security.keymint.KeyCreationResult generateKey(android.hardware.security.keymint.KeyParameter[] keyParams, android.hardware.security.keymint.AttestationKey attestationKey) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _Parcel.writeTypedObject(_data, attestationKey, 0);
          boolean _status = mRemote.transact(Stub.TRANSACTION_generateKey, _data, _reply, 0);
          _reply.readException();
          _result = _Parcel.readTypedObject(_reply, android.hardware.security.keymint.KeyCreationResult.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public byte[] upgradeKey(byte[] keyBlobToUpgrade, android.hardware.security.keymint.KeyParameter[] upgradeParams) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_upgradeKey, _data, _reply, 0);
          _reply.readException();
      ...
      @Override public void deleteAllKeys() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_deleteAllKeys, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public void destroyAttestationIds() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_destroyAttestationIds, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public android.hardware.security.keymint.BeginResult begin(int purpose, byte[] keyBlob, android.hardware.security.keymint.KeyParameter[] params, android.hardware.security.keymint.HardwareAuthToken authToken) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _reply.readException();
          _result = _Parcel.readTypedObject(_reply, android.hardware.security.keymint.BeginResult.CREATOR);
        }
        finally {
          _reply.recycle();
          _data.recycle();
      ...
      @Override public void deviceLocked(boolean passwordOnly, android.hardware.security.secureclock.TimeStampToken timestampToken) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_deviceLocked, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public void earlyBootEnded() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_earlyBootEnded, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public byte[] convertStorageKeyToEphemeral(byte[] storageKeyBlob) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_convertStorageKeyToEphemeral, _data, _reply, 0);
          _reply.readException();
          _result = _reply.createByteArray();
        }
        finally {
      ...
      @Override public byte[] getRootOfTrustChallenge() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getRootOfTrustChallenge, _data, _reply, 0);
          _reply.readException();
      ...
      @Override public byte[] getRootOfTrust(byte[] challenge) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getRootOfTrust, _data, _reply, 0);
          _reply.readException();
          _result = _reply.createByteArray();
        }
        finally {
      ...
      @Override public void sendRootOfTrust(byte[] rootOfTrust) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_sendRootOfTrust, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
      ...
      @Override public void setAdditionalAttestationInfo(android.hardware.security.keymint.KeyParameter[] info) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setAdditionalAttestationInfo, _data, _reply, 0);
          _reply.readException();
        }
        finally {
          _reply.recycle();
  ...
  /** @hide */
  public static final java.lang.String DESCRIPTOR = "android.hardware.security.keymint.IKeyMintDevice";
